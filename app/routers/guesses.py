...
from ..database import get_profile_info, get_guesses, record_guesses, update_user_guesses, get_match_status, get_fixtures_results
...
def games(request: Request, page_id: str):
    ...
    return templates.TemplateResponse(
        ...
        context={'guesses': guesses, 'message': message, 'match_status': match_status, 'results': results}
    )
